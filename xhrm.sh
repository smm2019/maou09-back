...
function getData()
{
    ...
    echo ""
    read -p " 请设置密码（不输入则随机生成）:" PASSWORD
...
menu() {
    ...
    echo -e "  ${GREEN}3.  ${RED}卸载${PLAIN}"
    echo " -------------"
    echo -e "  ${GREEN}4.${PLAIN}  启动"
    echo -e "  ${GREEN}5.${PLAIN}  重启"
    echo -e "  ${GREEN}6.${PLAIN}  停止"
    echo " -------------"
